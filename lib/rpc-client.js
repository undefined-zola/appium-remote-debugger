...
export default class RpcClient {
  ...
  ///====zola: add method 
  zola_updateAppsWithDict(appDic = {}) {
    this.zola_testRemoteDebugAppDic = appDic;  
    this.remoteMessages.zola_updateRemoteDebugAppDic(appDic);
    return;
  }
  ...
  setCommunicationProtocol (isTargetBased = false) {
    ...
    if (!this.remoteMessages) {
      this.remoteMessages = new RemoteMessages(isTargetBased, this.zola_testRemoteDebugAppDic);
    } else {
